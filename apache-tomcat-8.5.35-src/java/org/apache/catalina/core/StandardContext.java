...
public class StandardContext extends ContainerBase
    ...
    protected synchronized void startInternal() throws LifecycleException {
        ...
        // Post work directory
        //生成工作目录 也就是我们看到的那个work目录
        postWorkDirectory();

        //tomcat有3种资源
        //pre 资源 context.xml <Preresource></Preresource>
        //mian资源 WEB-INF文件夹中的classes lib
        //jar资源 <JarResoruce></JarResource>
        //post资源 <PostResource></PostResource>
