...
//        Exception e = new Exception(); 调试加的代码
//        e.printStackTrace();  调试加的代码
            ...
            if (interestOps == OP_REGISTER) {
                ...
                try {
                    if (key == null) {
                        ...
                        // closed.
                        //LimitLatch：连接控制器，负责控制最大的连接数  调用这个方法给连接数减1
    ...
    public class Poller implements Runnable {
        ...
        public void register(final NioChannel socket) {
            ...
            //将socket封装成PollerEvnet 加入到EventQueue
            ...
            while (true) {
                ...
                try {
                    ...
                    if (close) {
                        ...
                        //遍历eventqueue中的所有PollarEvent,然后依次调用PollarEvent中的run方法，将socket注册到selector中，selector会选择具体的ScoketProcessor进行处理
                        events();
                        timeout(0, false);
                        try {
                            selector.close();
